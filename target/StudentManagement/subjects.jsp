...
<head>
    <meta charset="UTF-8">
    <title>Subjects - Student Feedback System</title>
    ...
    <div class="container">
        <div class="page-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="page-title mb-0">📚 Manage Subjects</h4>
                <a href="addSubject.jsp" class="btn btn-add">+ Add Subject</a>
            </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <%
                    try {
                        ...
                        ResultSet rs = con.createStatement().executeQuery("SELECT * FROM subjects ORDER BY id DESC");
                        int sr = 1;
                        while (rs.next()) {
                %>
                    <tr>
                        ...
                        <td>
                            <a href="subject?action=delete&id=<%= rs.getInt("id") %>"
